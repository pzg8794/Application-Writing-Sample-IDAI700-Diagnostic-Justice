...
{\Large \textbf{EQUITAS: Enforceable Equity for Diagnostic AI}}

\vspace{0.6cm}

{\large A Justice-Based Framework for CLD Adolescents in Healthcare AI}

\vspace{1.4cm}

{\normalsize \textit{Research Question:} \\
\textbf{How can we design diagnostic AI systems that are ethically accountable to culturally and linguistically diverse (CLD) adolescents—especially those with ADHD, trauma, and chronic illness—by embedding enforceable equity, procedural justice, and epistemic inclusion into the AI lifecycle?}}
...
{\footnotesize
Prepared as a comprehensive ethical research framework fulfilling the final paper requirements for IDAI700 (Ethics of Artificial Intelligence) and integrating findings from ED415 (Adolescent Development). This paper synthesizes six peer-reviewed sources from my IDAI700 Research Portfolio: Nadarzynski et al. (2024) on co-design and trust, Lekadir et al. (2025) on governance, Sagona et al. (2025) on measurable trust, Marko et al. (2025) on documented disparities, Chen et al. (2023) on ethics as metrics, and Munn (2023) on the failure of toothless frameworks. These are grounded in empirical data from my ED415 Research Brief. EQUITAS presents a cross-disciplinary solution for AI diagnostic harm through enforceable infrastructure, co-authorship by affected communities, and civic resistance tools for structural accountability.
}
...
%==============================================================================
% GUIDING QUESTION: What's your topic? Why does it have important ethical dimensions? What's the main ethical position you will advance?
...
%==============================================================================
% GUIDING QUESTION: What do the scholarly sources in your research portfolio say about this issue? What's your take on their positions? How have these articles informed your understanding of the ethical dimensions?
...
My Resistance Mapping (Entry 3) provides \textit{the literacy}: civic capacity for communities to read and act on systems.
...
%==============================================================================
% GUIDING QUESTION: In full detail, what's your ethical argument?
...
%==============================================================================
% GUIDING QUESTION: Identify and respond to the strongest objection to your ethical position. Refutation. Acknowledging constraints.
...
\section{Conclusion}
%==============================================================================
% GUIDING QUESTION: Sum up your position. Clarify its practical implications for individuals and society.
...
%==============================================================================
% REFLECTION QUESTIONS: How specifically did you use AI? What did you learn about AI's abilities and limitations? Does your experience using AI connect to the ethical issues you researched? Did this experience change your perspective on AI ethics?
